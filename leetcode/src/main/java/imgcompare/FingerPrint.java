...
public class FingerPrint {
    ...
    public static void main(String[] args) throws Exception {
        for (int i = 2; i <= 3; i++) {
            FingerPrint fp1 = new FingerPrint(ImageIO.read(new File("C:\\Users\\\\Admin\\\\Desktop\\\\1108357-20181012172546090-1734271228.jpg")));
            FingerPrint fp2 = new FingerPrint(ImageIO.read(new File("C:\\Users\\Admin\\Desktop\\1108357-20181012172630075-1285730307.jpg")));
            System.out.println("两张图片的相似度为：" + fp1.compare(fp2) * 100 + "%");
        }
    }
}
