...
// 获取图像
        ...
        File imageFile1 = new File("C:\\Users\\Admin\\Desktop\\1108357-20181012172546090-1734271228.jpg");

        File file2 = new File("C:\\Users\\Admin\\Desktop\\1108357-20181012172630075-1285730307.jpg");

        getSimilarity(imageFile1, file2);

        //(数据类型)(最小值+Math.random()*(最大值-最小值+1))
        for (int i = 2; i <= 3; i++) {
            Double imageComparison =  ImageContrastUtil.imageComparison(new FileInputStream("C:\\Users\\Admin\\Desktop\\1108357-20181012172546090-1734271228.jpg"),new FileInputStream("C:\\Users\\Admin\\Desktop\\1108357-20181012172630075-1285730307.jpg"));
            System.out.println("两张图片的相似度为：" + imageComparison * 100 + "%");
            System.out.println(imageComparison.compareTo(Double.parseDouble("50")));
            imageComparison = imageComparison * 100;
            if(imageComparison.compareTo(Double.parseDouble("50")) > 1){
                System.out.println("两张图片的相似度可视为一张图片");
            }
        }
